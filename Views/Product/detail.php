         ...
         <div class="row g-4 mb-5">
             <div class="col-lg-8 col-xl-9">
                 <div class="row g-4">
                     ...
                     <div class="col-lg-6">
                         <h4 class="fw-bold mb-3"><?php echo $data['product']['ProductName'] ?></h4>

                         <?php
                            foreach ($data['categories'] as $category) {
                                if ($category['Id'] == $data['product']['CategoryID']) {
                                    echo '<p class="mb-3">Category: ' . $category['CategoryName'] . '</p>';
                                    break;
                                }
                            }
                            ?>

                         <h5 class="fw-bold mb-3"><?php echo $data['product']['Price'] ?> $</h5>
                             ...
                             <?php
                                ...
                                for ($i = 1; $i <= 5; $i++) {
                                    if ($i <= $fullStars) {
                                        ...
                                        echo '<i class="fa fa-star-half-alt text-secondary"></i>';
                                    } else {
                         ...
                         <form id="productForm" method="POST" action="">
                             ...
                             <button type="submit" name="submit" class="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary">
 ...
 <script>
    ...
    xhr.open('POST', './index.php?controller=product&action=addToCart', true);
  
  

    xhr.send(formData);
});
     const maxQuantity = <?php echo $data['product']['Quantity']; ?>;
     ...
     document.getElementById('quantity').addEventListener('input', function() {
         ...
         if (isNaN(currentQuantity) || currentQuantity < 1) {
             ...
             alert('The quantity exceeds the available stock. Setting to the maximum available quantity.');
         }
     });
